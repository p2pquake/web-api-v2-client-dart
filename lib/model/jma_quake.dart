...
class JMAQuake {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is JMAQuake &&
     other.id == id &&
     other.code == code &&
     other.time == time &&
     other.issue == issue &&
  ...
  @override
  String toString() => 'JMAQuake[id=$id, code=$code, time=$time, issue=$issue, earthquake=$earthquake, points=$points]';
  ...
  static List<JMAQuake> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <JMAQuake>[]
  ...
  static Map<String, List<JMAQuake>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
