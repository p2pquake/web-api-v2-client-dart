...
class Areapeers {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is Areapeers &&
     other.id == id &&
     other.code == code &&
     other.time == time &&
     other.areas == areas;
  ...
  static List<Areapeers> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <Areapeers>[]
  ...
  static Map<String, List<Areapeers>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
