...
class UserquakeEvaluationAllOf {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UserquakeEvaluationAllOf &&
     other.code == code &&
     other.count == count &&
  ...
  @override
  String toString() => 'UserquakeEvaluationAllOf[code=$code, count=$count, confidence=$confidence, startedAt=$startedAt, updatedAt=$updatedAt, time=$time, areaConfidences=$areaConfidences]';
  ...
  static List<UserquakeEvaluationAllOf> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <UserquakeEvaluationAllOf>[]
      : json.map((v) => UserquakeEvaluationAllOf.fromJson(v)).toList(growable: true == growable);

  static Map<String, UserquakeEvaluationAllOf> mapFromJson(Map<String, dynamic> json) {
    final map = <String, UserquakeEvaluationAllOf>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) => map[key] = UserquakeEvaluationAllOf.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of UserquakeEvaluationAllOf-objects as value to a dart map
  static Map<String, List<UserquakeEvaluationAllOf>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<UserquakeEvaluationAllOf>>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = UserquakeEvaluationAllOf.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
