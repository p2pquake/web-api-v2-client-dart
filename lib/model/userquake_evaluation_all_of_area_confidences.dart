...
class UserquakeEvaluationAllOfAreaConfidences {
  ...
  bool operator ==(Object other) =>
      ...
      other is UserquakeEvaluationAllOfAreaConfidences &&
          other.confidence == confidence &&
          other.count == count &&
          other.display == display;

  @override
  int get hashCode => confidence.hashCode + count.hashCode + display.hashCode;

  @override
  String toString() =>
      'UserquakeEvaluationAllOfAreaConfidences[confidence=$confidence, count=$count, display=$display]';
    ...
    bool growable,
      ...
      json == null || json.isEmpty
          ? true == emptyIsNull
              ...
              : <UserquakeEvaluationAllOfAreaConfidences>[]
          : json
              .map((v) => UserquakeEvaluationAllOfAreaConfidences.fromJson(v))
  ...
  static Map<String, UserquakeEvaluationAllOfAreaConfidences> mapFromJson(
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) =>
          map[key] = UserquakeEvaluationAllOfAreaConfidences.fromJson(v));
    }
    return map;
  }
